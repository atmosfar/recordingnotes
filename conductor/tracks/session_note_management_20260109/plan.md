...
- [x] Task: Update `public/style.css` to handle sidebar session item hover actions and "Manage Sessions" mode. [e8b43c2]
- [x] Task: Update `public/app.js` to implement session renaming and deletion logic. [e8b43c2]
- [x] Task: Update `public/index.html` to include the "Manage Sessions" button for mobile. [e8b43c2]
