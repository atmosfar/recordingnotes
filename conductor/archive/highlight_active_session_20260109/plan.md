...
- [x] Task: Manually verify deep-linking with long and short session lists. [0b7fe0b]
- [x] Task: Manually verify highlight consistency after creating a new session. [0b7fe0b]
